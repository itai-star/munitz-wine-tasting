      ...
      {sessions.map((session) => (
        ...
        >
          ...
          <Link
            ...
            className="block w-full text-center text-sm px-4 py-2.5 bg-wine text-white rounded-lg hover:bg-wine-dark transition-colors font-medium mb-3"
          >
            צפה בתוצאות
          </Link>
          <div className="flex gap-2">
            <Link
              ...
              className="flex-1 text-center text-xs px-3 py-1.5 border border-stone-300 text-stone-600 rounded-lg hover:bg-stone-50 transition-colors"
            >
              צפה
            </Link>
            <button
              ...
              className="flex-1 text-xs px-3 py-1.5 border border-stone-300 text-stone-600 rounded-lg hover:bg-stone-50 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading === session.id}
              className="flex-1 text-xs px-3 py-1.5 border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition-colors disabled:opacity-50"
            >
              מחק
            </button>
          </div>
